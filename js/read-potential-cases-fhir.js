...
(async () => {
  ...
  await fs.writeFile("chronic-viral-hepatitis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("chronic-viral-hepatitis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
